...
//        webView.configuration.websiteDataStore.removeData(ofTypes: dataTypes, modifiedSince: .distantPast, completionHandler: {})
        ...
        guard let url = URL(string: "https://www.amazon.com/gp/video/storefront/ref=atv_tc_prime") else {
            return
        }
...
extension ViewController: WKScriptMessageHandler {
    ...
    func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
        if message.name == "requestFullscreen", let boolValue = (message.body as? NSNumber)?.boolValue, let window = view.window {
